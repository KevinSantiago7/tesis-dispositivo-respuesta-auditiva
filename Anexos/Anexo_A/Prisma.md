...
|---|---:|---:|---:|
| Muestra de control (Baja) | 42 | 108 | 150 |

El 28,0 % de la muestra presentó relación potencial con el proyecto. Este resultado se declara como **limitación metodológica del filtro automático**: el estrato de Baja prioridad probablemente contiene estudios adicionales de relevancia no revisados por restricciones de tiempo y alcance del trabajo de grado. No debe interpretarse como una estimación poblacional exacta del estrato completo (n = 4131), dado que corresponde a una muestra exploratoria.
...
Priorización temática automatizada:
   Alta = 39 | Media = 1824 | Baja = 4131
        ↓
Verificación manual artículo por artículo:
   ...
   Baja:  muestra de control 150/4131 → 42 potencialmente relacionados (28,0 %),
        ...
        ↓
Total revisado manualmente: 439 de 5994 (7,3 %)
        ↓
Núcleo con síntesis individual (A.7):        n = 59
Apoyo (Incluir sin ficha propia + Apoyo):    n = 225
```
...
El proceso documentado en este anexo —priorización automatizada, verificación manual con decisión artículo por artículo sobre 439 registros, control de sensibilidad sobre el estrato de baja prioridad (n = 150) y verificación bibliográfica de las 59 referencias núcleo contra la base Zotero/CSV— permite trazar cada cifra reportada hasta su origen.
