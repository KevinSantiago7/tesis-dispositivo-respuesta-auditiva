...
El proceso integró dos herramientas complementarias de gestión bibliográfica y cribado: **Zotero**, utilizado para la importación, organización y depuración inicial de referencias (incluida la eliminación de duplicados), y **Rayyan**, utilizado como plataforma de cribado estructurado mediante filtros temáticos acumulativos.

Esta revisión corresponde a una revisión estructurada orientada al desarrollo tecnológico del dispositivo y no a una revisión sistemática clínica con metaanálisis. No se trata de una aplicación estricta de PRISMA 2020: el cribado en Rayyan se realizó mediante filtros acumulativos progresivos y no mediante doble revisión independiente entre los dos autores ni cálculo de índice de concordancia (ej. Kappa de Cohen). Estas particularidades se detallan en A.9 y A.13.
...
2. Respuestas conductuales y fisiológicas observables en población infantil.
3. Visión computacional aplicada al análisis infantil.
4. Aprendizaje automático para clasificación de patrones observables.

---

## A.3 Bases bibliográficas y herramientas de gestión documental
...
### A.3.1 Zotero — gestión y depuración bibliográfica inicial

Zotero fue utilizado como herramienta inicial para la administración de las referencias obtenidas desde las cuatro bases bibliográficas consultadas. Las actividades realizadas fueron:

- Importación de registros bibliográficos.
- Organización de referencias por temática.
- Normalización de metadatos.
- Identificación y eliminación de registros duplicados.
- Preparación del conjunto documental para su exportación hacia Rayyan.

| Etapa | Cantidad |
|---|---:|
| Registros importados | 6567 |
| Duplicados eliminados | 573 |
| Registros únicos exportados a Rayyan | 5994 |

### A.3.2 Rayyan — cribado y selección documental

Las referencias depuradas en Zotero fueron exportadas a Rayyan para realizar el proceso estructurado de cribado. Rayyan permitió:

- Gestión de los registros importados.
- Detección adicional de duplicados.
- Aplicación de filtros temáticos acumulativos.
- Priorización y clasificación de estudios según pertinencia.

---

## A.4 Estrategia de búsqueda

Las búsquedas bibliográficas fueron realizadas durante el periodo comprendido entre diciembre de 2025 y marzo de 2026, mediante las bases de datos seleccionadas: PubMed, Scopus, IEEE Xplore y ScienceDirect. La estrategia se estructuró a partir de cuatro líneas temáticas relacionadas con los componentes principales del proyecto, utilizando operadores booleanos AND y OR para ampliar la recuperación de literatura pertinente.
...
> **Nota de consistencia:** el filtro final aplicado en Rayyan (A.5, tercera etapa) utilizó únicamente el término *"artificial intelligence"*, mientras que la ecuación de búsqueda original incluía también los sinónimos *"machine learning"* y *"deep learning"* mediante OR. Esta diferencia se declara como limitación en A.13.

---

## A.5 Criterios de pertinencia documental

### Inclusión
Se consideraron pertinentes los estudios que:
- incluyeran población infantil (bebés, neonatos o niños);
- evaluaran respuestas auditivas o conductuales frente a estímulos sonoros;
- implementaran dispositivos, sensores, visión computacional o herramientas tecnológicas;
- utilizaran inteligencia artificial, aprendizaje automático, análisis automatizado o dispositivos computacionales aplicables al desarrollo del dispositivo.

### Exclusión
Se excluyeron los estudios que:
- no estuvieran relacionados con población infantil (p. ej. exclusivamente en adultos o modelos animales);
- no presentaran relación con evaluación auditiva o respuesta ante estímulos;
- utilizaran inteligencia artificial sin aplicabilidad al dispositivo propuesto;
- correspondieran a revisiones sin aporte metodológico directo.

---

## A.6 Proceso de cribado en Rayyan
...
|---|---:|
| Relación auditiva | 804 |
| Inteligencia artificial aplicada | 146 |

### A.6.1 Evaluación detallada de pertinencia

Los 146 registros resultantes del filtrado acumulativo fueron evaluados individualmente contra los criterios de inclusión y exclusión de A.5. Esta evaluación fue realizada dividiendo los registros entre los dos autores, **sin doble revisión independiente ni cálculo de índice de concordancia** (ver limitación en A.13).

| Fase | Número |
|---|---:|
| Registros únicos después de Zotero | 5994 |
| Filtro población infantil | 2373 |
| Filtro auditivo | 804 |
| Filtro inteligencia artificial | 146 |
| Evaluación detallada de pertinencia | 146 |
| **Estudios incluidos en síntesis cualitativa** | **59** |

---

## A.7 Estudios incluidos en la síntesis cualitativa (núcleo, n = 59)

> Referencias verificadas una a una contra el archivo Zotero/CSV original (autor, año, revista y DOI reales).

### A.7.1 Evaluación auditiva infantil y dispositivos tecnológicos (n = 20)
...
### A.7.2 Respuesta conductual y fisiológica observable en población infantil (n = 7)
...
| Mukai, Morita, Shirai y Wakida (2019). *Automatic Classification of Neonatal Sleep-Wake States Based on Facial Video Analysis*. IEEE ICITR. DOI: 10.1109/ICITR49409.2019.9407788 | Clasificación de estados sueño-vigilia a partir de conducta facial observable. |
...
| Dorantes Olvera, López, Martinez y Rivera (2016). *Noninvasive monitoring system for early detection of apnea in newborns and infants*. IEEE EMBS Conference on Biomedical Engineering. DOI: 10.1109/IECBES.2016.7843500 | Monitoreo neonatal no invasivo de respuesta fisiológica. |
...
| Park y Hong (2023). *Facial Video-Based Robust Measurement of Respiratory Rates in Various Environmental Conditions*. Journal of Sensors. DOI: 10.1155/2023/9207750 | Medición de respuesta fisiológica (frecuencia respiratoria) mediante video facial. |
| Fitter, Funke, Pulido et al. (2020). *Toward Predicting Infant Developmental Outcomes from Day-Long Inertial Motion Recordings*. IEEE TNSRE. DOI: 10.1109/TNSRE.2020.3016916 | Predicción de resultados de desarrollo a partir de registros de movimiento. |

### A.7.3 Visión computacional aplicada al análisis infantil (n = 23)
...
| Marino, Migliorelli, Moccia y Sirocchi (2024). *A Monitoring Support System Based on HRNet+DEKR for Neonatal Intensive Care Units*. DOI: no disponible en el registro exportado de Zotero (ver A.13). | Estimación de pose neonatal (keypoints) para monitoreo en UCIN. |
...
### A.7.4 Inteligencia artificial y aprendizaje automático (n = 9)
...
La literatura evidencia avances individuales en tamizaje auditivo, análisis de movimiento infantil, visión computacional y aprendizaje automático. Sin embargo, estos enfoques generalmente se desarrollan de forma independiente. La brecha identificada corresponde a la integración de:
...
Registros identificados:            n = 6567
        ↓
Gestión y depuración en Zotero
        ↓
Duplicados eliminados:              n = 573
        ↓
Registros únicos:                   n = 5994
        ↓
Importación a Rayyan
        ↓
Filtro población infantil:          n = 2373
        ↓
Filtro relación auditiva:           n = 804
        ↓
Filtro inteligencia artificial:     n = 146
        ↓
Evaluación detallada de pertinencia (individual, 146 registros)
        ↓
Estudios incluidos en síntesis cualitativa (A.7):   n = 59
```
...
El proceso documentado en este anexo —depuración inicial en Zotero, cribado estructurado mediante filtros acumulativos en Rayyan, evaluación individual de pertinencia sobre 146 registros y verificación bibliográfica de las 59 referencias núcleo contra la base Zotero/CSV— permite trazar cada cifra reportada hasta su origen.

## A.13 Limitaciones

1. El filtro final de inteligencia artificial aplicado en Rayyan utilizó únicamente el término *"artificial intelligence"*, mientras que la ecuación de búsqueda original (A.4) incluía también los sinónimos *"machine learning"* y *"deep learning"*. Es posible que este filtro más restrictivo haya excluido registros relevantes que emplearan solo alguno de esos sinónimos sin la frase exacta "artificial intelligence".
2. La evaluación detallada de pertinencia de los 146 registros preseleccionados fue realizada dividiendo los registros entre los dos autores, **sin doble revisión independiente ni cálculo de índice de concordancia** (ej. Kappa de Cohen). Esta es una limitación declarada del proceso.
3. El cribado por filtros acumulativos (población → auditivo → IA) es una estrategia secuencial de tipo AND: un registro excluido en una etapa temprana (p. ej. por no contener el término "hearing" en título/resumen/palabras clave) no fue reevaluado en etapas posteriores, aun si era pertinente por otras vías (p. ej. visión computacional aplicada sin mención explícita de "hearing"). Esto pudo excluir estudios relevantes de las líneas 2, 3 y 4 de la pregunta de revisión que no mencionaran explícitamente el término auditivo.
4. La referencia Corso et al. (2027) fue verificada: corresponde a un artículo de conferencia publicado en Lecture Notes in Computer Science (vol. 16748, Springer), con registro confirmado en Scopus. El año 2027 corresponde al copyright asignado por Springer a la publicación anticipada del volumen, no a un error de la revisión.
5. La referencia Marino, Migliorelli, Moccia y Sirocchi (2024) no cuenta con DOI disponible en el registro exportado de Zotero; se recomienda verificarlo directamente en la fuente antes de la entrega final.
