...
| Origen del registro | Categórico | Diferencia entre registros reales y registros simulados trazables. |
...
| Ruta del archivo audiovisual | Ubicación del video asociado al ensayo, para consulta posterior. |
...
| Movimiento cefálico | Línea base, amplitud, velocidad, energía, variabilidad (incluye `std_delta_yaw`) | Representación cuantitativa del movimiento registrado. |
