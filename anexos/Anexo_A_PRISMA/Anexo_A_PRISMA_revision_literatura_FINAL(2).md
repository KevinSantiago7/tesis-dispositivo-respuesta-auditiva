...
Sobre los 5994 registros únicos se realizó un cribado preliminar
mediante título, resumen y metadatos, priorizando documentos
relacionados con:
...
Como resultado de esta priorización se identificaron 39 artículos con
alta relación temática para evaluación detallada.
...
# A.7 Estudios científicos incluidos en la síntesis cualitativa

## Evaluación auditiva infantil

  -----------------------------------------------------------------------
  Referencia                          Aporte a la revisión
  ----------------------------------- -----------------------------------
  Norton et al. (2000)                Evaluación mediante emisiones
                                      otoacústicas en neonatos.

  Chan et al. (2022)                  Desarrollo de un dispositivo
                                      portátil basado en OAE.

  Thornton et al. (2003)              Factores asociados a pruebas OAE
                                      neonatales.

  Stuart y Yang (2001)                Caracterización de respuestas
                                      auditivas ABR.
...
## Respuesta conductual frente al sonido
  ...
  Ferronato et al. (2014)             Relación entre estímulos auditivos
                                      y cambios motores infantiles.

  Kezuka et al. (2017)                Desarrollo de orientación hacia
                                      fuentes sonoras.

  Hicks et al. (2000)                 Limitaciones de pruebas auditivas
...
## Visión computacional infantil
  ...
  Leo et al. (2022)                   Estado del arte en análisis
                                      automático de movimiento infantil.

  Hashemi et al. (2014)               Visión computacional aplicada al
                                      comportamiento infantil.

  Automatic pose estimation in        Estimación automática de pose
  newborn infants (2026)              neonatal.

  Neonatal Face and Facial Landmark   Detección facial y landmarks
  Detection from Video Recordings     neonatales.
  (2023)                              

  Automatic quantitative intelligent  Seguimiento automático de
  assessment of neonatal movements    movimientos neonatales.
  with video tracking (2024)          

  Head Orientation Estimation of      Estimación de orientación cefálica
  Infants using Deep Learning (2023)  infantil.
  -----------------------------------------------------------------------
...
## Inteligencia artificial aplicada
  ...
  Blankenship et al. (2026)           Clasificación automática de
                                      reacciones frente a sonidos
                                      mediante aprendizaje automático.

  Kulvicius et al. (2025)             Clasificación automática de
                                      movimientos infantiles mediante IA.
  -----------------------------------------------------------------------
...
Estos documentos contextualizan la importancia clínica de la detección
auditiva temprana:

  -----------------------------------------------------------------------
  Documento                           Uso
  ----------------------------------- -----------------------------------
  World Health Organization           Contexto mundial de pérdida
                                      auditiva infantil.

  Joint Committee on Infant Hearing   Recomendaciones para detección e
  (2019)                              intervención temprana.

  ASHA                                Conceptos relacionados con pérdida
                                      auditiva infantil.
...
# A.9 Referencias metodológicas

Estas referencias sustentan la implementación y evaluación del
dispositivo:

  Referencia                Uso
  ------------------------- --------------------------------------------
  PRISMA 2020               Metodología de revisión estructurada.
  Breiman (2001)            Algoritmo Random Forest.
  Pedregosa et al. (2011)   Implementación mediante Scikit-learn.
  Lugaresi et al. (2019)    Framework MediaPipe.
  Kartynnik et al. (2019)   Geometría facial desde video monocular.
  OpenCV                    Procesamiento visual y estimación de pose.
  Brooke (1996)             Escala System Usability Scale.
  Davis (1989)              Modelo de aceptación tecnológica TAM.

------------------------------------------------------------------------

# A.10 Síntesis de la revisión y brecha tecnológica
...
Sin embargo, se observa una integración aún limitada entre:
...
La selección final corresponde a los estudios científicos que aportan
directamente al estado del arte del dispositivo, complementados por
documentos clínicos y referencias metodológicas.
